# Convert the block of stringy numbers into an array of arrays
# The array should be read as [x,y]
# Iterate each Y into each X (y++ before x++)
# Do 4 checks:
	# 4 adjacent vertically
	# 4 adjacent horizontally
	# 4 diagonally ( // positive slope)
	# 4 diagonally ( \\ negative slope)
# For each, multiply together the 4 numbers
	# If it's larger than last_largest_prime, keep it
	# Else, keep going
# After all numbers have been cycled through, return the last largest product
